...
```
### Step 5: Load ReFrame and the git repository
```bash
module load devel/ReFrame/4.3.3
```
```bash
...
```
### Step 6 : Change the header of the reframe_openfoam.py example to this:
```bash
import reframe as rfm
import reframe.utility.sanity as sn
from reframe.utility.sanity import defer

Openfoam_Mbike(rfm.RunOnlyRegressionTest):
```

### Step 7 : Use the Reframe to automate the execution of the reframe_openfoam.py file
```bash
